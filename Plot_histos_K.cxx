...
void Plot_histos_K(int e_energy = 18, int p_energy = 275)
{
  ...
  for(unsigned int Q2bin = 0; Q2bin < nQ2bins; Q2bin++)
  {
    for(unsigned int y_bin = 0; y_bin < nyInelParBins; y_bin++)
    {
      ...
      {
        TCanvas *K_minus_lead_eta_pfRICH_can = new TCanvas(Form("K_minus_lead_eta_pfRICH_can_Q2_%i_y_%i" , Q2bin, y_bin), Form("K_minus_lead_eta_pfRICH_can_Q2_%i_y_%i" , Q2bin, y_bin), 1200, 1000);
        ...
        h_eta_K_minus_lead_MC_pfRICH[Q2bin][y_bin]->GetYaxis()->CenterTitle();
        h_eta_K_minus_lead_MC_pfRICH[Q2bin][y_bin]->SetMarkerStyle(34);
      ...
      if( h_eta_K_plus_MC[Q2bin][y_bin]->Integral() > 0 )
      {
        ...
        K_plus_eta_pfRICH_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/EIC/EICrecon/figs/%ix%i/K_purity/K_plus_eta_Q2_%i_y_%i.png" ,e_energy, p_energy, Q2bin, y_bin));
      ...
      {
        TCanvas *K_plus_lead_eta_pfRICH_can = new TCanvas(Form("K_plus_lead_eta_pfRICH_can_Q2_%i_y_%i" , Q2bin, y_bin), Form("K_plus_lead_eta_pfRICH_can_Q2_%i_y_%i" , Q2bin, y_bin), 1200, 1000);
        K_plus_lead_eta_pfRICH_can->cd();

        gPad->SetLogy();


        h_eta_K_plus_lead_MC[Q2bin][y_bin]->GetXaxis()->SetTitle("#eta");
        h_eta_K_plus_lead_MC[Q2bin][y_bin]->GetXaxis()->CenterTitle();
        h_eta_K_plus_lead_MC[Q2bin][y_bin]->GetYaxis()->SetTitle("Counts");
        h_eta_K_plus_lead_MC[Q2bin][y_bin]->GetYaxis()->CenterTitle();
        h_eta_K_plus_lead_MC[Q2bin][y_bin]->SetMarkerStyle(28);
        h_eta_K_plus_lead_MC[Q2bin][y_bin]->SetMarkerColor(4);
        ...
        h_eta_K_plus_lead_MC_pfRICH[Q2bin][y_bin]->GetYaxis()->CenterTitle();
        h_eta_K_plus_lead_MC_pfRICH[Q2bin][y_bin]->SetMarkerStyle(34);
      ...
      TPaveText *Text_K_RC = new TPaveText(0.25, 0.65, 0.5, 0.85, "NDC");
      Text_K_RC->SetTextFont(42);
      Text_K_RC->AddText(Form("MC ep DIS %ix%i GeV", e_energy, p_energy));
      //Text_K_RC->AddText(Form("%0.1f < p < %0.1f GeV/c", mom_bins, mom_bins[mom_bin+1]));
      Text_K_RC->AddText(Form("%0.1f < Q^{2} < %0.1f GeV^{2}/c^{2}", Q2_bins[Q2bin], Q2_bins[Q2bin+1]));
      Text_K_RC->AddText(Form("%0.3f < y < %0.3f", y_bins[y_bin], y_bins[y_bin+1]));
      Text_K_RC->SetFillColorAlpha(0, 0.01);

      //K-
      h_eta_K_minus_RC[Q2bin][y_bin] = (TH1F*)inFile->Get(Form("h_eta_K_minus_MC_RC_Q2_%i_y_%i" , Q2bin, y_bin));
      h_eta_K_minus_RC_pfRICH[Q2bin][y_bin] = (TH1F*)inFile->Get(Form("h_eta_K_minus_MC_RC_pfRICH_Q2_%i_y_%i" , Q2bin, y_bin));

      if( h_eta_K_minus_RC[Q2bin][y_bin]->Integral() > 0 )
      {
        TCanvas *K_minus_eta_pfRICH_RC_can = new TCanvas(Form("K_minus_eta_pfRICH_RC_can_Q2_%i_y_%i" , Q2bin, y_bin), Form("K_minus_eta_pfRICH_RC_can_Q2_%i_y_%i" , Q2bin, y_bin), 1200, 1000);
        K_minus_eta_pfRICH_RC_can->cd();

        gPad->SetLogy();


        h_eta_K_minus_RC[Q2bin][y_bin]->GetXaxis()->SetTitle("#eta");
        h_eta_K_minus_RC[Q2bin][y_bin]->GetXaxis()->CenterTitle();
        h_eta_K_minus_RC[Q2bin][y_bin]->GetYaxis()->SetTitle("Counts");
        h_eta_K_minus_RC[Q2bin][y_bin]->GetYaxis()->CenterTitle();
        h_eta_K_minus_RC[Q2bin][y_bin]->SetMarkerStyle(28);
        h_eta_K_minus_RC[Q2bin][y_bin]->SetMarkerColor(4);
        h_eta_K_minus_RC[Q2bin][y_bin]->SetLineColor(4);
        h_eta_K_minus_RC[Q2bin][y_bin]->Draw("p e");


        h_eta_K_minus_RC_pfRICH[Q2bin][y_bin]->GetXaxis()->SetTitle("#eta");
        h_eta_K_minus_RC_pfRICH[Q2bin][y_bin]->GetXaxis()->CenterTitle();
        h_eta_K_minus_RC_pfRICH[Q2bin][y_bin]->GetYaxis()->SetTitle("Counts");
        h_eta_K_minus_RC_pfRICH[Q2bin][y_bin]->GetYaxis()->CenterTitle();
      ...
      //K+
      h_eta_K_plus_RC[Q2bin][y_bin] = (TH1F*)inFile->Get(Form("h_eta_K_plus_MC_RC_Q2_%i_y_%i" , Q2bin, y_bin));
      h_eta_K_plus_RC_pfRICH[Q2bin][y_bin] = (TH1F*)inFile->Get(Form("h_eta_K_plus_MC_RC_pfRICH_Q2_%i_y_%i" , Q2bin, y_bin));

      if( h_eta_K_plus_RC[Q2bin][y_bin]->Integral() > 0 )
      {

        TCanvas *K_plus_eta_pfRICH_RC_can = new TCanvas(Form("K_plus_eta_pfRICH_RC_can_Q2_%i_y_%i" , Q2bin, y_bin), Form("K_plus_eta_pfRICH_RC_can_Q2_%i_y_%i" , Q2bin, y_bin), 1200, 1000);
        K_plus_eta_pfRICH_RC_can->cd();

        gPad->SetLogy();

        h_eta_K_plus_RC[Q2bin][y_bin]->GetXaxis()->SetTitle("#eta");
        h_eta_K_plus_RC[Q2bin][y_bin]->GetXaxis()->CenterTitle();
        h_eta_K_plus_RC[Q2bin][y_bin]->GetYaxis()->SetTitle("Counts");
        h_eta_K_plus_RC[Q2bin][y_bin]->GetYaxis()->CenterTitle();
        h_eta_K_plus_RC[Q2bin][y_bin]->SetMarkerStyle(28);
        h_eta_K_plus_RC[Q2bin][y_bin]->SetMarkerColor(4);
        h_eta_K_plus_RC[Q2bin][y_bin]->SetLineColor(4);
        h_eta_K_plus_RC[Q2bin][y_bin]->Draw("p e");


        h_eta_K_plus_RC_pfRICH[Q2bin][y_bin]->GetXaxis()->SetTitle("#eta");
        h_eta_K_plus_RC_pfRICH[Q2bin][y_bin]->GetXaxis()->CenterTitle();
        h_eta_K_plus_RC_pfRICH[Q2bin][y_bin]->GetYaxis()->SetTitle("Counts");
        h_eta_K_plus_RC_pfRICH[Q2bin][y_bin]->GetYaxis()->CenterTitle();
        h_eta_K_plus_RC_pfRICH[Q2bin][y_bin]->SetMarkerStyle(34);
        h_eta_K_plus_RC_pfRICH[Q2bin][y_bin]->SetMarkerColor(8);
        h_eta_K_plus_RC_pfRICH[Q2bin][y_bin]->SetLineColor(8);
        h_eta_K_plus_RC_pfRICH[Q2bin][y_bin]->Draw("p e same");

        Text_K_RC->Draw("same");

        K_plus_eta_pfRICH_RC_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/EIC/EICrecon/figs/%ix%i/K_purity/K_plus_RC_eta_Q2_%i_y_%i.png" ,e_energy, p_energy, Q2bin, y_bin));
      ...
      {
        TCanvas *K_minus_purity_pfRICH_RC_can = new TCanvas(Form("K_minus_purity_pfRICH_RC_can_Q2_%i_y_%i" , Q2bin, y_bin), Form("K_minus_purity_pfRICH_RC_can_Q2_%i_y_%i" , Q2bin, y_bin), 1200, 1000);
      ...
      {
        TCanvas *K_plus_purity_pfRICH_RC_can = new TCanvas(Form("K_plus_purity_pfRICH_RC_can_Q2_%i_y_%i" , Q2bin, y_bin), Form("K_plus_purity_pfRICH_RC_can_Q2_%i_y_%i" , Q2bin, y_bin), 1200, 1000);

        K_plus_purity_pfRICH_RC_can->cd();


        h_K_plus_purity_pfRICH_RC[Q2bin][y_bin]->Draw();

        double nK = h_K_plus_purity_pfRICH_RC[Q2bin][y_bin]->GetBinContent(2);
        double nBackground = h_K_plus_purity_pfRICH_RC[Q2bin][y_bin]->GetBinContent(1);
  ...
  for(unsigned int eta_bin = 0; eta_bin < nEtaBins+1; eta_bin++)
  {
    ...
    {
      TCanvas *K_minus_lead_p_pfRICH_can = new TCanvas(Form("K_minus_lead_p_pfRICH_can_eta_%i" , eta_bin), Form("K_minus_lead_p_pfRICH_can_eta_%i" , eta_bin), 1200, 1000);
      K_minus_lead_p_pfRICH_can->cd();

      gPad->SetLogy();

      h_p_K_minus_lead_MC[eta_bin]->GetXaxis()->SetTitle("p (GeV/#it{c})");
    ...
    {
      TCanvas *K_plus_lead_p_pfRICH_can = new TCanvas(Form("K_plus_lead_p_pfRICH_can_eta_%i" , eta_bin), Form("K_plus_lead_p_pfRICH_can_eta_%i" , eta_bin), 1200, 1000);
      K_plus_lead_p_pfRICH_can->cd();

      gPad->SetLogy();

      h_p_K_plus_lead_MC[eta_bin]->GetXaxis()->SetTitle("p (GeV/#it{c})");
      h_p_K_plus_lead_MC[eta_bin]->GetXaxis()->CenterTitle();
      h_p_K_plus_lead_MC[eta_bin]->GetYaxis()->SetTitle("Counts");
      h_p_K_plus_lead_MC[eta_bin]->GetYaxis()->CenterTitle();
      h_p_K_plus_lead_MC[eta_bin]->SetMarkerStyle(28);
      h_p_K_plus_lead_MC[eta_bin]->SetMarkerColor(4);
      ...
      h_p_K_plus_lead_MC_pfRICH[eta_bin]->GetYaxis()->CenterTitle();
      h_p_K_plus_lead_MC_pfRICH[eta_bin]->SetMarkerStyle(34);
    ...
    {
      TCanvas *K_minus_p_pfRICH_RC_can = new TCanvas(Form("K_minus_p_pfRICH_RC_can_eta_%i" , eta_bin), Form("K_minus_p_pfRICH_RC_can_eta_%i" , eta_bin), 1200, 1000);
      K_minus_p_pfRICH_RC_can->cd();

      gPad->SetLogy();


      h_p_K_minus_RC[eta_bin]->GetXaxis()->SetTitle("p (GeV/#it{c})");
      ...
      h_p_K_minus_RC[eta_bin]->Draw("p e");


      h_p_K_minus_RC_pfRICH[eta_bin]->GetXaxis()->SetTitle("p (GeV/#it{c})");
      ...
      h_p_K_minus_RC_pfRICH[eta_bin]->Draw("p e same");
    ...
    if( h_p_K_plus_RC[eta_bin]->Integral() > 0 )
    {

      TCanvas *K_plus_p_pfRICH_RC_can = new TCanvas(Form("K_plus_p_pfRICH_RC_can_eta_%i" , eta_bin), Form("K_plus_p_pfRICH_RC_can_eta_%i" , eta_bin), 1200, 1000);
      K_plus_p_pfRICH_RC_can->cd();

      gPad->SetLogy();

      h_p_K_plus_RC[eta_bin]->GetXaxis()->SetTitle("p (GeV/#it{c})");
      h_p_K_plus_RC[eta_bin]->GetXaxis()->CenterTitle();
      h_p_K_plus_RC[eta_bin]->GetYaxis()->SetTitle("Counts");
      h_p_K_plus_RC[eta_bin]->GetYaxis()->CenterTitle();
      h_p_K_plus_RC[eta_bin]->SetMarkerStyle(28);
      h_p_K_plus_RC[eta_bin]->SetMarkerColor(4);
      h_p_K_plus_RC[eta_bin]->SetLineColor(4);
      h_p_K_plus_RC[eta_bin]->Draw("p e");


      h_p_K_plus_RC_pfRICH[eta_bin]->GetXaxis()->SetTitle("p (GeV/#it{c})");
      h_p_K_plus_RC_pfRICH[eta_bin]->GetXaxis()->CenterTitle();
      h_p_K_plus_RC_pfRICH[eta_bin]->GetYaxis()->SetTitle("Counts");
      h_p_K_plus_RC_pfRICH[eta_bin]->GetYaxis()->CenterTitle();
      h_p_K_plus_RC_pfRICH[eta_bin]->SetMarkerStyle(34);
      h_p_K_plus_RC_pfRICH[eta_bin]->SetMarkerColor(8);
      h_p_K_plus_RC_pfRICH[eta_bin]->SetLineColor(8);
      h_p_K_plus_RC_pfRICH[eta_bin]->Draw("p e same");

      Text_K_p_RC->Draw("same");

      K_plus_p_pfRICH_RC_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/EIC/EICrecon/figs/%ix%i/K_purity/K_plus_RC_p_eta_%i.png", e_energy, p_energy, eta_bin));
    ...
    //K+
    h_K_plus_purity_p_eta_pfRICH_RC[eta_bin] = (TH1F*)inFile->Get(Form("h_K_plus_purity_p_eta_pfRICH_MC_RC_eta_%i" , eta_bin));
    ...
    if(h_K_plus_purity_p_eta_pfRICH_RC[eta_bin]->Integral() != 0 )
    {
      ...
      double nK = h_K_plus_purity_p_eta_pfRICH_RC[eta_bin]->GetBinContent(2);
      double nBackground = h_K_plus_purity_p_eta_pfRICH_RC[eta_bin]->GetBinContent(1);

      double K_plus_purity = ( nK/(nK+nBackground) )*100;

      TPaveText *Text_K_plus_minus_purity_RC = new TPaveText(0.55, 0.65, 0.84, 0.85, "NDC");
      Text_K_plus_minus_purity_RC->SetTextFont(42);
      Text_K_plus_minus_purity_RC->AddText(Form("RC ep DIS %ix%i GeV", e_energy, p_energy));
      Text_K_plus_minus_purity_RC->AddText(Form("K pfRICH purity: %0.1f%%", K_plus_purity));
      //Text_K_plus_minus_purity_RC->AddText(Form("%0.1f < p < %0.1f GeV/c", mom_bins, mom_bins[mom_bin+1]));
      if(eta_bin < nEtaBins) Text_K_plus_minus_purity_RC->AddText(Form("%0.1f < #eta < %0.1f GeV/c", eta_bins[eta_bin], eta_bins[eta_bin+1]));
      else Text_K_plus_minus_purity_RC->AddText(Form("%0.1f < #eta < %0.1f GeV/c", eta_bins[0], eta_bins[nEtaBins]));
