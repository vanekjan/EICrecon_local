...
*/
  ...
  TH1D *h_pi_pfRICH_PID_eff_MC_RC[4]; //PID efficiency - no PID baseline, good PID and mis-PID
  TH1D *h_K_pfRICH_PID_eff_MC_RC[4];
  TH1D *h_p_pfRICH_PID_eff_MC_RC[4];
  ...
  for(unsigned int PID_bin = 0; PID_bin < 4; PID_bin++)
  {
    ...
    h_pi_pfRICH_PID_eff_MC_RC[PID_bin] = (TH1D*)inFile->Get(Form("h_pi_pfRICH_PID_eff_MC_RC_%i", PID_bin)); //PID efficiency - good PID and mis-PID
    h_K_pfRICH_PID_eff_MC_RC[PID_bin] = (TH1D*)inFile->Get(Form("h_K_pfRICH_PID_eff_MC_RC_%i", PID_bin));
    h_p_pfRICH_PID_eff_MC_RC[PID_bin] = (TH1D*)inFile->Get(Form("h_p_pfRICH_PID_eff_MC_RC_%i", PID_bin));
  }
  ...
  TCanvas *pfRICH_PID_eff_MC_RC = new TCanvas("pfRICH_PID_eff_MC_RC", "pfRICH_PID_eff_MC_RC", 3600, 3000);
  pfRICH_PID_eff_MC_RC->Divide(3,3);
  ...
  for(unsigned int PID_bin = 1; PID_bin < 4; PID_bin++)
  {
    ...
    pfRICH_PID_eff_MC_RC->cd(PID_bin);

    if(PID_bin == 1) h_pi_pfRICH_PID_eff_MC_RC[0]->Sumw2();
    h_pi_pfRICH_PID_eff_MC_RC[PID_bin]->Sumw2();
    h_pi_pfRICH_PID_eff_MC_RC[PID_bin]->Divide(h_pi_pfRICH_PID_eff_MC_RC[PID_bin], h_pi_pfRICH_PID_eff_MC_RC[0], 1, 1, "b");
    h_pi_pfRICH_PID_eff_MC_RC[PID_bin]->GetXaxis()->SetTitle("p_{MC_RC} (GeV/#it{c})");
    h_pi_pfRICH_PID_eff_MC_RC[PID_bin]->GetXaxis()->CenterTitle();
    h_pi_pfRICH_PID_eff_MC_RC[PID_bin]->GetYaxis()->SetTitle("Efficiency");
    h_pi_pfRICH_PID_eff_MC_RC[PID_bin]->GetYaxis()->CenterTitle();
    h_pi_pfRICH_PID_eff_MC_RC[PID_bin]->Draw("p e");
    ...
    pfRICH_PID_eff_MC_RC->cd(PID_bin+3);

    if(PID_bin == 1) h_K_pfRICH_PID_eff_MC_RC[0]->Sumw2();
    h_K_pfRICH_PID_eff_MC_RC[PID_bin]->Sumw2();
    h_K_pfRICH_PID_eff_MC_RC[PID_bin]->Divide(h_K_pfRICH_PID_eff_MC_RC[PID_bin], h_K_pfRICH_PID_eff_MC_RC[0], 1, 1, "b");
    h_K_pfRICH_PID_eff_MC_RC[PID_bin]->GetXaxis()->SetTitle("p_{MC_RC} (GeV/#it{c})");
    h_K_pfRICH_PID_eff_MC_RC[PID_bin]->GetXaxis()->CenterTitle();
    h_K_pfRICH_PID_eff_MC_RC[PID_bin]->GetYaxis()->SetTitle("Efficiency");
    h_K_pfRICH_PID_eff_MC_RC[PID_bin]->GetYaxis()->CenterTitle();
    h_K_pfRICH_PID_eff_MC_RC[PID_bin]->Draw("p e");

    pfRICH_PID_eff_K_text[PID_bin-1]->Draw("same");


    pfRICH_PID_eff_MC_RC->cd(PID_bin+6);

    if(PID_bin == 1) h_p_pfRICH_PID_eff_MC_RC[0]->Sumw2();
    h_p_pfRICH_PID_eff_MC_RC[PID_bin]->Sumw2();
    h_p_pfRICH_PID_eff_MC_RC[PID_bin]->Divide(h_p_pfRICH_PID_eff_MC_RC[PID_bin], h_p_pfRICH_PID_eff_MC_RC[0], 1, 1, "b");
    h_p_pfRICH_PID_eff_MC_RC[PID_bin]->GetXaxis()->SetTitle("p_{MC_RC} (GeV/#it{c})");
    h_p_pfRICH_PID_eff_MC_RC[PID_bin]->GetXaxis()->CenterTitle();
    h_p_pfRICH_PID_eff_MC_RC[PID_bin]->GetYaxis()->SetTitle("Efficiency");
    h_p_pfRICH_PID_eff_MC_RC[PID_bin]->GetYaxis()->CenterTitle();
    h_p_pfRICH_PID_eff_MC_RC[PID_bin]->Draw("p e");
  ...
  pfRICH_PID_eff_MC_RC->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/EIC/EICrecon/figs/%ix%i/pi_reject_reco_pfRICH/pfRICH_PID_eff_MC_RC.png", e_energy, p_energy));
  ...
  for(unsigned int mom_bin = 0; mom_bin < nMomBins; mom_bin++)
  {
    ...
    for(unsigned int Q2bin = 0; Q2bin < nQ2bins; Q2bin++)
    {
      for(unsigned int y_bin = 0; y_bin < nyInelParBins; y_bin++)
      {
        ...
        //reconstructed scattered electron
        h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin] = (TH1D*)inFile->Get(Form("h_eta_scat_ele_RC_mom_%i_Q2_%i_y_%i" , mom_bin, Q2bin, y_bin));
        ...
        //mis-PID with eCAL
        h_scat_ele_MC_RC_match[mom_bin][Q2bin][y_bin] = (TH1D*)inFile->Get(Form("h_scat_ele_MC_RC_match_mom_%i_Q2_%i_y_%i" , mom_bin, Q2bin, y_bin));

        if(h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->Integral() > 0)
        {

          TCanvas *eta_scat_ele_RC_can = new TCanvas(Form("eta_scat_ele_RC_can_mom_%i_Q2_%i_y_%i" , mom_bin, Q2bin, y_bin), Form("eta_scat_ele_RC_can_mom_%i_Q2_%i_y_%i" , mom_bin, Q2bin, y_bin), 1200, 1000);

          eta_scat_ele_RC_can->cd();

          gPad->SetLogy();

          h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->GetXaxis()->SetTitle("#eta");
          h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->GetXaxis()->CenterTitle();
          h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->GetYaxis()->SetTitle("Counts");
          h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->GetYaxis()->CenterTitle();
          h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->SetMaximum(h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->GetMaximum()*100);
          h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->SetMarkerStyle(20);
          h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->SetMarkerSize(2);
          h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->SetMarkerColor(1);
          h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->SetLineColor(1);
          //h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->SetMinimum(0);
          h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin]->Draw("p e");
          ...
          Leg_bins_RC->AddEntry(h_eta_scat_ele_RC[mom_bin][Q2bin][y_bin], "RC Scattered e^{-}");
          ...
          eta_scat_ele_RC_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/EIC/EICrecon/figs/%ix%i/pi_reject_reco/Eta_scat_e_RC_mom_%i_Q2_%i_yBin_%i.png", e_energy, p_energy, mom_bin , Q2bin, y_bin));


          //scattered electron purity histograms
          TCanvas *scat_ele_MC_RC_match_can = new TCanvas(Form("scat_ele_MC_RC_match_can_mom_%i_Q2_%i_y_%i" , mom_bin, Q2bin, y_bin), Form("scat_ele_MC_RC_match_can_mom_%i_Q2_%i_y_%i" , mom_bin, Q2bin, y_bin), 1200, 1000);

          scat_ele_MC_RC_match_can->cd();

          h_scat_ele_MC_RC_match[mom_bin][Q2bin][y_bin]->Draw();

          double nElectrons = h_scat_ele_MC_RC_match[mom_bin][Q2bin][y_bin]->GetBinContent(2);
          double nBackground = h_scat_ele_MC_RC_match[mom_bin][Q2bin][y_bin]->GetBinContent(1);
          ...
          scat_ele_MC_RC_match_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/EIC/EICrecon/figs/%ix%i/pi_reject_reco/scat_ele_MC_RC_match_mom_%i_Q2_%i_yBin_%i.png", e_energy, p_energy, mom_bin , Q2bin, y_bin));
        ...
        //mis-PID with eCAL
        h_scat_ele_MC_RC_match_pfRICH[mom_bin][Q2bin][y_bin] = (TH1D*)inFile->Get(Form("h_scat_ele_MC_RC_match_pfRICH_mom_%i_Q2_%i_y_%i" , mom_bin, Q2bin, y_bin));
        ...
        if(h_eta_scat_ele_RC_pfRICH[mom_bin][Q2bin][y_bin]->Integral() > 0)
        {
          ...
          //scattered electron purity histograms
          TCanvas *scat_ele_MC_RC_match_pfRICH_can = new TCanvas(Form("scat_ele_MC_RC_match_pfRICH_can_mom_%i_Q2_%i_y_%i" , mom_bin, Q2bin, y_bin), Form("scat_ele_MC_RC_match_pfRICH_can_mom_%i_Q2_%i_y_%i" , mom_bin, Q2bin, y_bin), 1200, 1000);

          scat_ele_MC_RC_match_pfRICH_can->cd();

          h_scat_ele_MC_RC_match_pfRICH[mom_bin][Q2bin][y_bin]->Draw();

          double nElectrons = h_scat_ele_MC_RC_match_pfRICH[mom_bin][Q2bin][y_bin]->GetBinContent(2);
          double nBackground = h_scat_ele_MC_RC_match_pfRICH[mom_bin][Q2bin][y_bin]->GetBinContent(1);
          ...
          scat_ele_MC_RC_match_pfRICH_can->SaveAs(Form("/home/jvanek/C_drive_windows/Work/Analysis/EIC/EICrecon/figs/%ix%i/pi_reject_reco_pfRICH/scat_ele_MC_RC_pfRICH_match_mom_%i_Q2_%i_yBin_%i.png", e_energy, p_energy, mom_bin , Q2bin, y_bin));
